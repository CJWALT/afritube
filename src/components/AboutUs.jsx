...
const AboutUs = () => {
  return (
    <div className="fixed top-0 left-0 w-[100%] h-[100%] z-[999] bg-white rounded">
        <div className="flex flex-col justify-center items-center text-center mx-auto m-4 p-8 w-[100%] md:w-[60%]">
      <BiX className='p-2 rounded-full bg-white my-4 text-4xl text-black absolute right-4 top-0 cursor-pointer' />
